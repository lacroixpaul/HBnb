...
- price (float): The price per night for the place (required, must be positive).
- latitude (float): Latitude coordinate for the place's location (required, between -90.0 and 90.0).
- longitude (float): Longitude coordinate for the place's location (required, between -180.0 and 180.0).
- owner (User): The owner of the place, represented as a `User` instance (required).
